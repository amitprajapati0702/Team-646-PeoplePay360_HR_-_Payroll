            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <DialogDescription className="text-xs text-slate-500">
                  Create employee record, assign department & role, and configure account
                </DialogDescription>
              </div>
            </div>
          </DialogHeader>
          ...
          {isOptionsLoading ? (
            ...
            >
              <TabsList className="grid grid-cols-4 bg-slate-100 p-1 rounded-xl mb-4">
                ...
                <TabsTrigger value="job" className="text-xs flex items-center gap-1.5">
                  <Briefcase className="h-3.5 w-3.5" />
                  <span>Job & Org</span>
                </TabsTrigger>
                <TabsTrigger value="bank" className="text-xs flex items-center gap-1.5">
              ...
              <TabsContent value="job" className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                  ...
                  <div>
                    <label className="text-xs font-semibold text-slate-700 mb-1 block">
                      Working Schedule <span className="text-rose-500">*</span>
                    </label>
                    <Select
                  ...
                  <div className="sm:col-span-2">
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="NONE">No Manager (Independent)</SelectItem>
